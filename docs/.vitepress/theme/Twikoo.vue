...
<!--
 * @FilePath: /docs/.vitepress/theme/Twikoo.vue
 * @Description: TODO
...
<template>
  <div class="comment-container vp-raw">
    ...
    <!-- Twikoo -->
    <div id="twikoo"></div>
    <component :is="'script'" src="https://cdn.jsdelivr.net/npm/twikoo@1.6.39/dist/twikoo.min.js" crossorigin="anonymous" ref="twikooJs"></component>
  </div>
</template>